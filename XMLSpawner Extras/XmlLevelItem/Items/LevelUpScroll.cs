...
namespace Server.Items
{
	public class LevelUpScroll : Item
	{
		...
		{
			if (m_Value == 5.0)
				LabelTo(from, "a wonderous scroll of Leveling (+{0} max levels)", m_Value);
			else if (m_Value == 10.0)
				LabelTo(from, "an exalted scroll of Leveling (+{0} max levels)", m_Value);
			else if (m_Value == 15.0)
				LabelTo(from, "a mythical scroll of Leveling (+{0} max levels)", m_Value);
			else if (m_Value == 20.0)
				LabelTo(from, "a legendary scroll of Leveling (+{0} max levels)", m_Value);
			else
				LabelTo(from, "a scroll of Leveling (+{0} max levels)", m_Value);
		}

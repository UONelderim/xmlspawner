...
namespace Server.Items
{
	public class BaseSiegeProjectile : Item, ISiegeProjectile
	{
		...
		public virtual int AnimationHue => 0;

		public virtual double MobDamageMultiplier => 1.0; // default damage multiplier for creatures
		public virtual double StructureDamageMultiplier => 1.0; // default damage multiplier for structures
...
*/
		...
		*/
		...
		public void OnHit(Mobile from, ISiegeWeapon weapon, IEntity target, Point3D targetloc)
		{
			...
			if (itemlist != null)
				foreach (Item item in itemlist)
				{
					...
					if (item is AddonComponent)
					{
						...
						if (a != null && !damagelist.Contains(a)) damagelist.Add(a);
					}
				}
			...
			var totaldamage = FireDamage + PhysicalDamage;
			if (totaldamage > 0)
			{
				var scaledmobdamage = (int)(totaldamage * MobDamageMultiplier * weapon.WeaponDamageFactor);
				var phys = 100 * PhysicalDamage / totaldamage;
				var fire = 100 * FireDamage / totaldamage;
		...
		private class SiegeWeaponTarget : Target
		{
			...
			protected override void OnTarget(Mobile from, object targeted)
			{
				...
				else if (targeted is SiegeComponent) weapon = ((SiegeComponent)targeted).Addon as ISiegeWeapon;

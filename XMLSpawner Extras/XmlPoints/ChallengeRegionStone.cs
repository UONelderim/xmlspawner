...
namespace Server.Engines.XmlSpawner2
{
	public class ChallengeRegionStone : Item
	{
		...
		[CommandProperty(AccessLevel.GameMaster)]
		public ChallengeGameRegion ChallengeRegion => m_ChallengeRegion;
		...
		{
			if (m_ChallengeRegion != null) m_ChallengeRegion.Unregister();
		...
		public override void Serialize(GenericWriter writer)
		{
			...
			if (m_ChallengeRegion != null && m_ChallengeRegion.Area != null && m_ChallengeRegion.Area.Length > 0)
			{
				...
				for (var i = 0; i < m_ChallengeRegion.Area.Length; i++)
				{

...
namespace Server.Engines.XmlSpawner2
{
	public class XmlSocketable : XmlAttachment
	{
		...
		public override string OnIdentify(Mobile from)
		{
			...
			var s = XmlAttach.FindAttachment(AttachedTo, typeof(XmlSockets)) as XmlSockets;
			...
			else if (MaxSockets == -1) msg = String.Format("Can be socketed.");
			...
			if (from != null)
			{
				...
				var success = XmlSockets.ComputeSuccessChance(from, nSockets, MinSkillLevel, RequiredSkill,

...
namespace Server.Items
{
	public class SiegeCatapult : BaseSiegeWeapon
	{
		...
		public override double WeaponDamageFactor => base.WeaponDamageFactor * 1.0; // damage multiplier for the weapon
		public override double WeaponRangeFactor => base.WeaponRangeFactor * 1.0; //  range multiplier for the weapon

		public override int MinTargetRange => 3; // target must be further away than this
		...
		public override void UpdateDisplay()
		{
			...
			{
				var z = ((AddonComponent)Components[1]).Location.Z;

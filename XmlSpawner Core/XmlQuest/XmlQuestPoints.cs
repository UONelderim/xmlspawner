...
namespace Server.Engines.XmlSpawner2
{
	public class XmlQuestPoints : XmlAttachment
	{
		...
		public List<QuestEntry> QuestList
		{
			get => m_QuestList;
		...
		public static void CheckQuestPoints_OnCommand(CommandEventArgs e)
		{
			...
			if (p != null) msg = p.OnIdentify(e.Mobile);
		...
		public static void QuestLog_OnCommand(CommandEventArgs e)
		{
			...
			e.Mobile.CloseGump<XMLQuestLogGump>();
		...
		public static void GiveQuestPoints(Mobile from, IXmlQuest quest)
		{
			...
			if (from != null) @from.SendMessage("You have received {0} quest points!", points);
		...
		public override void Serialize(GenericWriter writer)
		{
			...
			if (QuestList != null)
			{
				...
				foreach (var e in QuestList) e.Serialize(writer);
			}
			else
				writer.Write((int)0);
		...
		public override void Deserialize(GenericReader reader)
		{
			...
			switch (version)
			{
				case 0:
					...
					var quester = reader.ReadMobile();

					// rebuild the ranking list
					// if they have never made a kill, then dont rank
					if (quester != null && QuestsCompleted > 0) XmlQuestLeaders.UpdateQuestRanking(quester, this);
					break;
			}
		}

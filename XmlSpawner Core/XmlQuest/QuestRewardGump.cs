...
namespace Server.Gumps
{
	public class QuestRewardGump : Gump
	{
		...
		public QuestRewardGump(Mobile from, int page) : base(20, 30)
		{
			...
			var height = maxItemsPerPage * y_inc + 120;
			var width = x_pointsoffset + 110;
			...
			*/
			...
			var qcredits = XmlQuestPoints.GetCredits(from);
			AddLabel(400, 20, 0, String.Format("Available Credits: {0}", qcredits));
			var qpoints = XmlQuestPoints.GetPoints(from);
		...
		public override void OnResponse(NetState state, RelayInfo info)
		{
			...
			switch (info.ButtonID)
			{
				case 12:
					...
					var page = viewpage + 1;
					if (page > (int)(nitems / maxItemsPerPage)) page = (int)(nitems / maxItemsPerPage);

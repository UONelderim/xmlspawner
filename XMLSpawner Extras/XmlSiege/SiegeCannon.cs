...
namespace Server.Items
{
	...
	{
		public override double WeaponLoadingDelay => 15; // base delay for loading this weapon
		...
		public SiegeCannon(int facing)
		{
			...
			for (var i = 0; i < CannonNorth.Length; i++) AddComponent(new SiegeComponent(0, Name), 0, 0, 0);

...
namespace Server.Items
{
	...
	public class MythicSkull : BaseSocketAugmentation, IMythicAugment
	{
		...
		public override int Icon => 0x2203;
		...
		{
			if (target is BaseArmor || target is BaseWeapon || target is BaseCreature) return true;

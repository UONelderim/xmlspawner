...
namespace Server.Items
{
	...
	public class CombinationLock : Item
	{
		...
		public int CheckDigit(object o, string property)
		{
			...
			var argtest = BaseXmlSpawner.ParseString(property, 2, "<>!=");
			if (argtest.Length > 1)
			{
			...
			var result = BaseXmlSpawner.GetPropertyValue(null, o, property, out ptype);

			var arglist = BaseXmlSpawner.ParseString(result, 2, "=");
			if (arglist.Length < 2) return -1;
			var arglist2 = BaseXmlSpawner.ParseString(arglist[1], 2, " ");
		...
		public int CurrentValue
		{
			get
			{
				var value = Digit0 + Digit1 * 10 + Digit2 * 100 + Digit3 * 1000 + Digit4 * 10000 + Digit5 * 100000 +
